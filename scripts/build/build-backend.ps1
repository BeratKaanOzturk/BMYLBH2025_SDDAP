# Build Backend API - BMYLBH2025_SDDAP (Fixed with full MSBuild path)
param(
...
Write-Host "=== BMYLBH2025_SDDAP Backend Build Script ===" -ForegroundColor Green
...
try {
    ...
    $BackendPath = "Backend/BMYLBH2025_SDDAP"
    ...
    if ($RunTests) {
        ...
        dotnet test BMYLBH2025_SDDAP.Tests/BMYLBH2025_SDDAP.Tests.csproj --configuration $Configuration
        if ($LASTEXITCODE -ne 0) {
